  ...
  <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
         ...
         {/* <Link className='text-md text-center relative left-10 bottom-5 kanit'>The coding Academy</Link> */}
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			<div className="space-y-3">
				<h3 className="tracki uppercase dark:text-gray-50">Course</h3>
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2023 stylofixer hub. All rights reserved.</div>
</footer></>
  )
}
