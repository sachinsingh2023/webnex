...
const Login = () => {
	return (
		...
		<div className="px-8 py-2 border">
	<div className="flex items-center mx-auto container justify-center md:justify-between py-2">
		<div>
			<span>Get up to 50% off your first registered + free notes Today !</span>
		</div>
			...
			<div className="login flex justify-center self-center">
				<div className="w-full border justify-center  max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100">
					...
					<form novalidate="" action="" className="space-y-6">
						...
						<div className="space-y-1 text-sm">
							...
							<div className="flex justify-end text-xs dark:text-gray-400">
								<NavLink rel="noopener noreferrer" href="#">Forgot Password?</NavLink>
							</div>
						</div>
						<button className="block w-1/2 text-center p-3 border  text-center rounded-sm ">Sign in</button>
					</form>
					...
					<p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
						<NavLink rel="noopener noreferrer" href="#" className="underline dark:text-gray-100">Sign up</NavLink>
					</p>
				</div></div></>
	)
}
